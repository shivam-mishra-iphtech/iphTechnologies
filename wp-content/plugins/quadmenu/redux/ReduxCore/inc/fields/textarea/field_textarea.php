<?php
	 ...
	 * @link        http://ReduxFrameworkLegacy.com
	 * @method      Test
...
if ( ! class_exists( 'ReduxFrameworkLegacy_textarea' ) ) {
	class ReduxFrameworkLegacy_textarea {

		/**
		 * Field Constructor.
		 *
		 * @param       $value  Constructed by Redux class. Based on the passing in $field['defaults'] value and what is stored in the database.
		 * @param       $parent ReduxFrameworkLegacy object is passed for easier pointing.
		 *
		...
		function render() {
			...
			// The $this->field variables are already escaped in the ReduxFrameworkLegacy Class.
			?>
