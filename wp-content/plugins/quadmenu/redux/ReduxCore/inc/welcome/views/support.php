<div class="wrap about-wrap" xmlns="http://www.w3.org/1999/html">
	...
	<div class="redux-badge">
		...
		<span><?php printf( __( 'Version %s', 'redux-framework' ), esc_html( ReduxFrameworkLegacy::$_version ) ); ?></span>
	</div>
		...
		<form id="supportform">
			...
			<fieldset id="final_support">
				...
				<div class="is_developer">
					...
					<a href="<?php echo esc_url( 'https://github.com/ReduxFrameworkLegacy/redux-framework/issues' ); ?>" target="_blank">
						<h4>https://github.com/ReduxFrameworkLegacy/redux-framework/issues</h4>
					</a>
				</div>
...
?>
				...
				<p>
					<em>
						<?php printf( wp_kses( __( 'Should the developer not be responsive, read the <a href="%s" target="_blank">following article</a> before asking for support from us directly.', 'redux-framework' ), array( 'a' => array( 'href' => array() ) ) ), esc_url( 'http://docs.ReduxFrameworkLegacy.com/core/support-defined/' ) ); ?>
					</em>
				</p>
				<input type="button"
						name="previous"
